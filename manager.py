#!/usr/bin/env python3
"""
Userbot — Userbot Instance & Manager (Pyrogram-based)

The message layer now runs on PYROGRAM — the same library as the simple
script that worked perfectly for you. Pyrogram handles every message in
parallel worker tasks, so replies are instant and nothing queues.
